...
// if( $localhost )
// {
//     define('HTTP',$HTTP.$_SERVER['HTTP_HOST'].'/construtoras/dorata/');
// }
// else
// {
//     $host = $_SERVER['HTTP_HOST'];

//     if ($host === 'quaxx.com.br')
//     {
//         define('HTTP',$HTTP.$_SERVER['HTTP_HOST'].'/clientes/dorata/');
//     } else {
...
$base_url   = HTTP;  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = 'q-admin/uploads/'; // path from base_url to base of upload folder (with start and final /)
// $upload_dir = '/cuidamecuida/q-admin/uploads/'; // path from base_url to base of upload folder (with start and final /)
